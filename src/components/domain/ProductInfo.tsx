...
export function ProductInfo({ 
  ...
  return (
    <div className="flex flex-col w-full h-full pt-8 md:pt-32 pb-32 md:pb-16 px-4 sm:px-8 md:pl-12 md:pr-16 md:max-w-xl">
      ...
      <p className="text-sm tracking-widest text-foreground mb-6">
      ...
      {/* Mobile View (Limited with + button) */}
      ...
      {/* Accordions (includes Shipping, Care) */}
